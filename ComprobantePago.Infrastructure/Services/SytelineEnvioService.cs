            ...
            CancellationToken ct = default)
        {
            ...
            if (lineaIgv != null)
            {
                var dto = new SLAptrxdsInsertDto
                {
                    ...
                    TaxRegNum            = lineaIgv.EsEmpleado && lineaIgv.NumRegFiscal.Length > 0 ? lineaIgv.NumRegFiscal[..Math.Min(25, lineaIgv.NumRegFiscal.Length)] : "",
                    TaxRegNumType        = lineaIgv.EsEmpleado && !string.IsNullOrEmpty(lineaIgv.NumRegFiscal) ? "T" : "",
            ...
            if (lineaExento != null && !exentoYaComoExpense)
            {
                var dto = new SLAptrxdsInsertDto
                {
                    ...
                    TaxRegNum            = lineaExento.EsEmpleado && lineaExento.NumRegFiscal.Length > 0 ? lineaExento.NumRegFiscal[..Math.Min(25, lineaExento.NumRegFiscal.Length)] : "",
                    TaxRegNumType        = lineaExento.EsEmpleado && !string.IsNullOrEmpty(lineaExento.NumRegFiscal) ? "T" : "",
